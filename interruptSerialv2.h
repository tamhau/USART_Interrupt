...
**************************************************/
 ...
 #ifndef INTERRUPTSERIALV2_H_
 #define INTERRUPTSERIALV2_H_
...
/* Initialize for USART */
 ...
 static void USART_send(volatile char data, uint8_t Buffer)
 {
   _inline_USART_send(data,Buffer);
 }


 static void USART_putstring(char *StringPtr, uint8_t Buffer)
 ...
 static void USART_putstring_P(const char *StringPtr, uint8_t Buffer)
 /* sends the characters from the string one at a time to the USART */
 {
